...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"node_modules/vanilla-tilt/lib/vanilla-tilt.js":[function(require,module,exports) {
'use strict';
...
},{}],"js/renderLoader.js":[function(require,module,exports) {
"use strict";
...
var renderLoader = function renderLoader() {
  _main.profileContainerEl.innerHTML = '<div class="loader"></div>';
};

var _default = renderLoader;
exports.default = _default;
},{"./main":"js/main.js"}],"node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var define;
/**
...
},{}],"js/renderContent.js":[function(require,module,exports) {
"use strict";
...
var renderContent = function renderContent(data) {
  _main.profileContainerEl.innerHTML = "<div class=\"profile-picture\"><img src=\"".concat(data.picture, "\" alt=\"user profil picture\"/></div>\n    <h2>").concat(data.firstName, " ").concat(data.lastName, "</h2>\n    <p class=\"biographie\">\n        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Officia,\n        adipisci. Atque vitae consectetur nam, quam minus esse aliquid at\n        labore voluptates sed, inventore optio. Esse possimus debitis veniam\n        eveniet necessitatibus. Lorem ipsum dolor sit, amet consectetur adipisicing elit.labore voluptates sed, inventore optio. Esse possimus debitis veniam.\n      </p>\n    <ul>\n    \n      <li class=\"username\"><ion-icon class=\"icon\" name=\"person-circle-outline\"></ion-icon> ").concat(data.username, "</li>\n      <li class=\"age\"><ion-icon class=\"icon\" name=\"accessibility-outline\"></ion-icon> ").concat(data.age, " years old</li>\n      \n      <li class=\"phone\"><ion-icon class=\"icon\" name=\"call-outline\"></ion-icon> ").concat(data.phone, "</li>\n      <li><ion-icon class=\"icon\" name=\"finger-print-outline\"></ion-icon> ").concat(data.gender, "</li>\n      <li class=\"email\"><ion-icon class=\"icon\" name=\"mail-outline\"></ion-icon> ").concat(data.email, "</li>\n      <li class=\"location\"><ion-icon class=\"icon\" name=\"location-outline\"></ion-icon> ").concat(data.city, ", ").concat(data.state, ", ").concat(data.country, "</li>\n      \n    </ul>");
};
...
exports.profileContainerEl = void 0;

var _axios = _interopRequireDefault(require("axios"));

var _vanillaTilt = _interopRequireDefault(require("vanilla-tilt"));

var _renderLoader = _interopRequireDefault(require("./renderLoader"));
...
"use-strict"; // general value

var profileContainerEl = document.querySelector(".profile-container"); // initiate tilt effect

exports.profileContainerEl = profileContainerEl;

_vanillaTilt.default.init(document.querySelector(".profile-picture"), {
  max: 25,
  speed: 400
});
...
var loadUserData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var res, results, data, dataValue;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            (0, _renderContent.default)(dataValue);
            _context.next = 14;
            break;
          ...
          case 11:
            ...
            profileContainerEl.innerHTML = "<p>".concat(_context.t0.message, "</p>");
...
loadUserData();
},{"axios":"node_modules/axios/index.js","vanilla-tilt":"node_modules/vanilla-tilt/lib/vanilla-tilt.js","./renderLoader":"js/renderLoader.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","./renderContent":"js/renderContent.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
